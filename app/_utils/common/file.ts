type T_FILE_UNIT = 'Byte' | 'KB' | 'MB' | 'GB' | 'TB' | 'PB' | 'EB' | 'ZB' | 'YB'
const FILE_UNITS: T_FILE_UNIT[] = ['Byte', 'KB', 'MB', 'GB', 'TB', 'PB', 'EB', 'ZB', 'YB']
...
export const getByteInfo = (byteData: number): {size: T_FILE_UNIT; value: number; idx: number} => {
